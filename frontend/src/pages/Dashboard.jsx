        ...
        <div className="space-y-5 pb-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            <Card className="p-6 lg:col-span-2">
              <p className="text-sm font-semibold text-gray-900 mb-6">Daily Orders (Last 30 Days)</p>
            ...
            <Card className="p-6 lg:col-span-1">
              <p className="text-sm font-semibold text-gray-900 mb-2">Top Selling Products</p>
              {pieData.length > 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            <Card className="p-6 lg:col-span-2">
              <p className="text-sm font-semibold text-gray-900 mb-6">Quarterly Profit & Loss</p>
              <div className="h-64 w-full">
                <ResponsiveContainer width="100%" height="100%">
