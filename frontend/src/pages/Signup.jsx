      ...
      <div className="min-h-screen w-full flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 xl:w-[55%] relative overflow-hidden"
          ...
          <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20 w-full">
            ...
            <div className="mt-12 space-y-4">
              {[
                { icon: 'M5 13l4 4L19 7', text: 'Free 14-day trial, no credit card required' },
                { icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', text: 'Setup in under 5 minutes' },
                { icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z', text: 'Join 10,000+ happy users' }
              ].map((item, i) => (
            ...
            {/* Stats */}
            <div className="mt-16 grid grid-cols-3 gap-6" style={{animation:'slideIn 0.8s ease-out 0.5s both'}}>
              {[
                ...
                <div key={i} className="text-center p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10">
                  <div className="text-2xl font-bold bg-gradient-to-r from-slate-300 to-slate-400 bg-clip-text text-transparent">{stat.value}</div>
        ...
        <div className="w-full lg:w-1/2 xl:w-[45%] flex items-center justify-center p-6 sm:p-10 bg-white relative overflow-hidden">
          ...
          <div className="w-full max-w-md" style={{animation:'scaleIn 0.6s ease-out forwards'}}>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div style={{animation:'slideUp 0.6s ease-out 0.2s both'}}>
                ...
                <div className={`relative transition-all duration-300 ${focused === 'name' ? 'transform scale-[1.01]' : ''}`}>
                  <div className={`absolute -inset-0.5 bg-gradient-to-r from-gray-400 to-gray-500 rounded-xl blur opacity-0 transition-opacity duration-300 ${focused === 'name' ? 'opacity-50' : ''}`}/>
                  <div className="relative">
                    <svg className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors duration-300 ${focused === 'name' ? 'text-gray-700' : 'text-gray-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Terms */}
              <div className="flex items-start gap-3" style={{animation:'slideUp 0.6s ease-out 0.45s both'}}>
                <input type="checkbox" required className="w-4 h-4 mt-1 rounded border-gray-300 bg-white text-gray-700 focus:ring-gray-500 focus:ring-offset-white"/>
                <span className="text-sm text-gray-600">
                  I agree to the{' '}
                  <Link to="/terms" className="text-gray-700 hover:text-gray-900 transition-colors">Terms of Service</Link>
                  {' '}and{' '}
            ...
            {/* Divider */}
            <div className="flex items-center gap-4 my-8" style={{animation:'slideUp 0.6s ease-out 0.55s both'}}>
            ...
            {/* Social */}
            <div className="grid grid-cols-3 gap-4" style={{animation:'slideUp 0.6s ease-out 0.6s both'}}>
              {[
                ...
                <button
                  key={i}
                  type="button"
                  className="group flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-slate-900/80 border border-slate-800 text-white hover:bg-slate-800 hover:border-slate-700 hover:scale-105 transition-all duration-300"
                >
            ...
            {/* Login link */}
            <div className="mt-8 text-center" style={{animation:'slideUp 0.6s ease-out 0.6s both'}}>
